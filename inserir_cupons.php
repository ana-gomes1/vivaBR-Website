...
session_start();
    ...
    $sql = "INSERT INTO tb_cupons (codigo, tipo, data_fim, ativo, criado_em, descricao, valor)
            VALUES ( '$cod', '$tipo', '$data_fim', 1, '$criado_em', '$descricao', '$valor')";
...
if ($conexao->query($sql) === TRUE) {
            ...
            $_SESSION['msg'] .= "Cupom cadastrado com sucesso";
            header("Location: home_adm.php");

            $incluidos = get_included_files();

            if (in_array('cadastro.html', $incluidos)) {
